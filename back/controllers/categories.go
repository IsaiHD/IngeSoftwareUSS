...
type CategoriesController struct {
	cate services.CategoryService
}

func (cate *CategoriesController) InitActivityControllerRouters(router *gin.Engine, categoriesService services.CategoryService) {
